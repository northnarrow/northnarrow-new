...
echo "     combat-rules.v4 + combat-rules.v6 + combat-allow.cidrs + agent_id +"
...
echo "     combat-rules.v4 + .v6 are operator-provided (configs/ has both;"
echo "     v6 preserves NDP — see its header); combat-allow.cidrs +"
